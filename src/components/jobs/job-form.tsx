...
import { EMPLOYMENT_TYPES, JOB_STATUSES } from "@/lib/validators/enums";
import type { EmploymentType, JobStatus } from "@/lib/validators/enums";
import { jobCreateSchema, jobUpdateSchema } from "@/lib/validators/job";
